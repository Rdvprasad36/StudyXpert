...
function Flow() {
  ...
  // Project management functions - removed unused functions
  ...
  const renderErrorNotification = () => {
    ...
    return (
      <div className='absolute top-0 left-0 right-0 z-10 p-3 bg-destructive/10 border-b border-destructive/20'>
