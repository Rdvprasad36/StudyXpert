      ...
      <Card>
        ...
        <CardContent className='p-6'>
          <div className='space-y-6'>
            ...
            {error && (
              <div className='bg-destructive/10 border border-destructive/20 p-3 rounded-md flex items-center gap-2 text-destructive'>
            ...
            <div className='space-y-4 max-h-[400px] overflow-y-auto pr-4 nowheel nodrag'>
              {data.results.map((result) => (
                <div
                  key={result.id}
                  className='flex items-start gap-4 bg-muted p-4 rounded-lg'
                >
                  <div className='pt-1'>
                    <Checkbox
